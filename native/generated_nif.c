...
static ERL_NIF_TERM nif_get_KMeansResult_centroids(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    KMeansResult* res;
    if (!enif_get_resource(env, argv[0], RES_TYPE_KMeansResult, (void**)&res)) return enif_make_badarg(env);
    ErlNifUInt64 size; if (!enif_get_uint64(env, argv[1], &size)) return enif_make_badarg(env); ErlNifBinary bin; enif_alloc_binary((size_t)size, &bin); memcpy(bin.data, res->centroids, (size_t)size); return enif_make_binary(env, &bin);
}

static ERL_NIF_TERM nif_get_KMeansResult_assignments(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    KMeansResult* res;
    if (!enif_get_resource(env, argv[0], RES_TYPE_KMeansResult, (void**)&res)) return enif_make_badarg(env);
    ErlNifUInt64 size; if (!enif_get_uint64(env, argv[1], &size)) return enif_make_badarg(env); ErlNifBinary bin; enif_alloc_binary((size_t)size, &bin); memcpy(bin.data, res->assignments, (size_t)size); return enif_make_binary(env, &bin);
}

static ERL_NIF_TERM nif_get_KMeansResult_inertia(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    KMeansResult* res;
    if (!enif_get_resource(env, argv[0], RES_TYPE_KMeansResult, (void**)&res)) return enif_make_badarg(env);
    return enif_make_double(env, res->inertia);
}

static ERL_NIF_TERM nif_get_KMeansResult_converged(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    KMeansResult* res;
    if (!enif_get_resource(env, argv[0], RES_TYPE_KMeansResult, (void**)&res)) return enif_make_badarg(env);
    return enif_make_int(env, res->converged);
}

static ERL_NIF_TERM nif_get_PCAModel_n_components(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    PCAModel* res;
    if (!enif_get_resource(env, argv[0], RES_TYPE_PCAModel, (void**)&res)) return enif_make_badarg(env);
    return enif_make_int(env, res->n_components);
}

static ERL_NIF_TERM nif_get_PCAModel_eigenvalues(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    PCAModel* res;
    if (!enif_get_resource(env, argv[0], RES_TYPE_PCAModel, (void**)&res)) return enif_make_badarg(env);
    ErlNifUInt64 size; if (!enif_get_uint64(env, argv[1], &size)) return enif_make_badarg(env); ErlNifBinary bin; enif_alloc_binary((size_t)size, &bin); memcpy(bin.data, res->eigenvalues, (size_t)size); return enif_make_binary(env, &bin);
}

static ERL_NIF_TERM nif_get_PCAModel_total_variance(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    PCAModel* res;
    if (!enif_get_resource(env, argv[0], RES_TYPE_PCAModel, (void**)&res)) return enif_make_badarg(env);
    return enif_make_double(env, res->total_variance);
}

static ERL_NIF_TERM nif_get_PCAResult_converged(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    PCAResult* res;
...
static ERL_NIF_TERM nif_fp_concat_i64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_input_a; if (!enif_inspect_binary(env, argv[0], &bin_input_a)) return enif_make_badarg(env); int64_t* ptr_input_a = (int64_t*)bin_input_a.data; /* validated with val_len_a */
    ErlNifBinary bin_input_b; if (!enif_inspect_binary(env, argv[1], &bin_input_b)) return enif_make_badarg(env); int64_t* ptr_input_b = (int64_t*)bin_input_b.data; /* validated with val_len_a */
    ...
    if (!validate_binary_size(&bin_input_a, 8, (size_t)val_len_a)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_input_b, 8, (size_t)val_len_a)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_contains_i64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_input; if (!enif_inspect_binary(env, argv[0], &bin_input)) return enif_make_badarg(env); int64_t* ptr_input = (int64_t*)bin_input.data; /* validated with val_n */
    ...
    if (!validate_binary_size(&bin_input, 8, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_correlation_f64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_x; if (!enif_inspect_binary(env, argv[0], &bin_x)) return enif_make_badarg(env); double* ptr_x = (double*)bin_x.data; /* validated with val_n */
    ErlNifBinary bin_y; if (!enif_inspect_binary(env, argv[1], &bin_y)) return enif_make_badarg(env); double* ptr_y = (double*)bin_y.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[2], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_x, 8, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_y, 8, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_detect_outliers_iqr_f64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_data; if (!enif_inspect_binary(env, argv[0], &bin_data)) return enif_make_badarg(env); double* ptr_data = (double*)bin_data.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[1], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    ...
    if (!validate_binary_size(&bin_data, 8, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_drop_n_i64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_input; if (!enif_inspect_binary(env, argv[0], &bin_input)) return enif_make_badarg(env); int64_t* ptr_input = (int64_t*)bin_input.data; /* validated with val_array_len */
    ...
    if (!validate_binary_size(&bin_input, 8, (size_t)val_array_len)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_dotp_f32(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_a; if (!enif_inspect_binary(env, argv[0], &bin_a)) return enif_make_badarg(env); float* ptr_a = (float*)bin_a.data; /* validated with val_n */
    ErlNifBinary bin_b; if (!enif_inspect_binary(env, argv[1], &bin_b)) return enif_make_badarg(env); float* ptr_b = (float*)bin_b.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[2], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_a, 4, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_b, 4, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_dotp_f64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_a; if (!enif_inspect_binary(env, argv[0], &bin_a)) return enif_make_badarg(env); double* ptr_a = (double*)bin_a.data; /* validated with val_n */
    ErlNifBinary bin_b; if (!enif_inspect_binary(env, argv[1], &bin_b)) return enif_make_badarg(env); double* ptr_b = (double*)bin_b.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[2], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_a, 8, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_b, 8, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_dotp_i16(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_a; if (!enif_inspect_binary(env, argv[0], &bin_a)) return enif_make_badarg(env); int16_t* ptr_a = (int16_t*)bin_a.data; /* validated with val_n */
    ErlNifBinary bin_b; if (!enif_inspect_binary(env, argv[1], &bin_b)) return enif_make_badarg(env); int16_t* ptr_b = (int16_t*)bin_b.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[2], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_a, 2, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_b, 2, (size_t)val_n)) return enif_make_badarg(env);
    int16_t res = fp_fold_dotp_i16(ptr_a, ptr_b, val_n);
    return enif_make_int(env, (int)res);
}

static ERL_NIF_TERM nif_fp_fold_dotp_i32(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_a; if (!enif_inspect_binary(env, argv[0], &bin_a)) return enif_make_badarg(env); int32_t* ptr_a = (int32_t*)bin_a.data; /* validated with val_n */
    ErlNifBinary bin_b; if (!enif_inspect_binary(env, argv[1], &bin_b)) return enif_make_badarg(env); int32_t* ptr_b = (int32_t*)bin_b.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[2], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_a, 4, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_b, 4, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_dotp_i64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_a; if (!enif_inspect_binary(env, argv[0], &bin_a)) return enif_make_badarg(env); int64_t* ptr_a = (int64_t*)bin_a.data; /* validated with val_n */
    ErlNifBinary bin_b; if (!enif_inspect_binary(env, argv[1], &bin_b)) return enif_make_badarg(env); int64_t* ptr_b = (int64_t*)bin_b.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[2], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_a, 8, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_b, 8, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_dotp_i8(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_a; if (!enif_inspect_binary(env, argv[0], &bin_a)) return enif_make_badarg(env); int8_t* ptr_a = (int8_t*)bin_a.data; /* validated with val_n */
    ErlNifBinary bin_b; if (!enif_inspect_binary(env, argv[1], &bin_b)) return enif_make_badarg(env); int8_t* ptr_b = (int8_t*)bin_b.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[2], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_a, 1, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_b, 1, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_dotp_u16(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_a; if (!enif_inspect_binary(env, argv[0], &bin_a)) return enif_make_badarg(env); uint16_t* ptr_a = (uint16_t*)bin_a.data; /* validated with val_n */
    ErlNifBinary bin_b; if (!enif_inspect_binary(env, argv[1], &bin_b)) return enif_make_badarg(env); uint16_t* ptr_b = (uint16_t*)bin_b.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[2], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_a, 2, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_b, 2, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_dotp_u32(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_a; if (!enif_inspect_binary(env, argv[0], &bin_a)) return enif_make_badarg(env); uint32_t* ptr_a = (uint32_t*)bin_a.data; /* validated with val_n */
    ErlNifBinary bin_b; if (!enif_inspect_binary(env, argv[1], &bin_b)) return enif_make_badarg(env); uint32_t* ptr_b = (uint32_t*)bin_b.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[2], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_a, 4, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_b, 4, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_dotp_u64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_a; if (!enif_inspect_binary(env, argv[0], &bin_a)) return enif_make_badarg(env); uint64_t* ptr_a = (uint64_t*)bin_a.data; /* validated with val_n */
    ErlNifBinary bin_b; if (!enif_inspect_binary(env, argv[1], &bin_b)) return enif_make_badarg(env); uint64_t* ptr_b = (uint64_t*)bin_b.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[2], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_a, 8, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_b, 8, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_dotp_u8(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_a; if (!enif_inspect_binary(env, argv[0], &bin_a)) return enif_make_badarg(env); uint8_t* ptr_a = (uint8_t*)bin_a.data; /* validated with val_n */
    ErlNifBinary bin_b; if (!enif_inspect_binary(env, argv[1], &bin_b)) return enif_make_badarg(env); uint8_t* ptr_b = (uint8_t*)bin_b.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[2], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_a, 1, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_b, 1, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_sumsq_f32(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_in; if (!enif_inspect_binary(env, argv[0], &bin_in)) return enif_make_badarg(env); float* ptr_in = (float*)bin_in.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[1], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_in, 4, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_sumsq_i16(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_in; if (!enif_inspect_binary(env, argv[0], &bin_in)) return enif_make_badarg(env); int16_t* ptr_in = (int16_t*)bin_in.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[1], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_in, 2, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_sumsq_i32(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_in; if (!enif_inspect_binary(env, argv[0], &bin_in)) return enif_make_badarg(env); int32_t* ptr_in = (int32_t*)bin_in.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[1], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_in, 4, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_sumsq_i64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_in; if (!enif_inspect_binary(env, argv[0], &bin_in)) return enif_make_badarg(env); int64_t* ptr_in = (int64_t*)bin_in.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[1], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_in, 8, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_sumsq_i8(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_in; if (!enif_inspect_binary(env, argv[0], &bin_in)) return enif_make_badarg(env); int8_t* ptr_in = (int8_t*)bin_in.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[1], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_in, 1, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_sumsq_u16(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_in; if (!enif_inspect_binary(env, argv[0], &bin_in)) return enif_make_badarg(env); uint16_t* ptr_in = (uint16_t*)bin_in.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[1], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_in, 2, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_sumsq_u32(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_in; if (!enif_inspect_binary(env, argv[0], &bin_in)) return enif_make_badarg(env); uint32_t* ptr_in = (uint32_t*)bin_in.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[1], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_in, 4, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_sumsq_u64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_in; if (!enif_inspect_binary(env, argv[0], &bin_in)) return enif_make_badarg(env); uint64_t* ptr_in = (uint64_t*)bin_in.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[1], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_in, 8, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_fold_sumsq_u8(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_in; if (!enif_inspect_binary(env, argv[0], &bin_in)) return enif_make_badarg(env); uint8_t* ptr_in = (uint8_t*)bin_in.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[1], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_in, 1, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_gaussian_nb_predict_batch(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ...
    ErlNifBinary bin_X; if (!enif_inspect_binary(env, argv[1], &bin_X)) return enif_make_badarg(env); double* ptr_X = (double*)bin_X.data; /* validated with val_n */
...
static ERL_NIF_TERM nif_fp_gaussian_nb_train(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_X; if (!enif_inspect_binary(env, argv[0], &bin_X)) return enif_make_badarg(env); double* ptr_X = (double*)bin_X.data; /* validated with val_n */
    ErlNifBinary bin_y; if (!enif_inspect_binary(env, argv[1], &bin_y)) return enif_make_badarg(env); int* ptr_y = (int*)bin_y.data; /* validated with val_n */
    int val_n; if (!enif_get_int(env, argv[2], (int*)&val_n)) return enif_make_badarg(env);
    ...
    if (!validate_binary_size(&bin_X, 8, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_y, 4, (size_t)val_n)) return enif_make_badarg(env);
    GaussianNBModel res = fp_gaussian_nb_train(ptr_X, ptr_y, val_n, val_d, val_n_classes); GaussianNBModel* res_ptr = enif_alloc_resource(RES_TYPE_GaussianNBModel, sizeof(GaussianNBModel)); *res_ptr = res; ERL_NIF_TERM ret_res = enif_make_resource(env, res_ptr); enif_release_resource(res_ptr);
    return ret_res;
}
...
static ERL_NIF_TERM nif_fp_intersect_i64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_array_a; if (!enif_inspect_binary(env, argv[0], &bin_array_a)) return enif_make_badarg(env); int64_t* ptr_array_a = (int64_t*)bin_array_a.data; /* validated with val_len_a */
    ErlNifBinary bin_array_b; if (!enif_inspect_binary(env, argv[1], &bin_array_b)) return enif_make_badarg(env); int64_t* ptr_array_b = (int64_t*)bin_array_b.data; /* validated with val_len_a */
    ErlNifUInt64 size_output; if (!enif_get_uint64(env, argv[2], &size_output)) return enif_make_badarg(env); ErlNifBinary out_bin_output; enif_alloc_binary((size_t)size_output, &out_bin_output); int64_t* ptr_output = (int64_t*)out_bin_output.data;
    size_t val_len_a; if (!enif_get_uint64(env, argv[3], (ErlNifUInt64*)&val_len_a)) return enif_make_badarg(env);
    size_t val_len_b; if (!enif_get_uint64(env, argv[4], (ErlNifUInt64*)&val_len_b)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_array_a, 8, (size_t)val_len_a)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_array_b, 8, (size_t)val_len_a)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_kmeans_f64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ...
    if (!validate_binary_size(&bin_data, 8, (size_t)val_n)) return enif_make_badarg(env);
    KMeansResult res = fp_kmeans_f64(ptr_data, val_n, val_d, val_k, val_max_iter, val_tol, val_seed); KMeansResult* res_ptr = enif_alloc_resource(RES_TYPE_KMeansResult, sizeof(KMeansResult)); *res_ptr = res; ERL_NIF_TERM ret_res = enif_make_resource(env, res_ptr); enif_release_resource(res_ptr);
    return ret_res;
}

static ERL_NIF_TERM nif_fp_linear_regression_r2_score(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_y_true; if (!enif_inspect_binary(env, argv[0], &bin_y_true)) return enif_make_badarg(env); double* ptr_y_true = (double*)bin_y_true.data; /* validated with val_n */
    ErlNifBinary bin_y_pred; if (!enif_inspect_binary(env, argv[1], &bin_y_pred)) return enif_make_badarg(env); double* ptr_y_pred = (double*)bin_y_pred.data; /* validated with val_n */
    int val_n; if (!enif_get_int(env, argv[2], (int*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_y_true, 8, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_y_pred, 8, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_map_abs_f64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_in; if (!enif_inspect_binary(env, argv[0], &bin_in)) return enif_make_badarg(env); double* ptr_in = (double*)bin_in.data; /* validated with val_n */
...
static ERL_NIF_TERM nif_fp_map_axpy_f32(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_x; if (!enif_inspect_binary(env, argv[0], &bin_x)) return enif_make_badarg(env); float* ptr_x = (float*)bin_x.data; /* validated with val_n */
    ErlNifBinary bin_y; if (!enif_inspect_binary(env, argv[1], &bin_y)) return enif_make_badarg(env); float* ptr_y = (float*)bin_y.data; /* validated with val_n */
    ...
    if (!validate_binary_size(&bin_x, 4, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_y, 4, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_map_axpy_i16(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_x; if (!enif_inspect_binary(env, argv[0], &bin_x)) return enif_make_badarg(env); int16_t* ptr_x = (int16_t*)bin_x.data; /* validated with val_n */
    ErlNifBinary bin_y; if (!enif_inspect_binary(env, argv[1], &bin_y)) return enif_make_badarg(env); int16_t* ptr_y = (int16_t*)bin_y.data; /* validated with val_n */
    ...
    if (!validate_binary_size(&bin_x, 2, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_y, 2, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_map_axpy_i32(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_x; if (!enif_inspect_binary(env, argv[0], &bin_x)) return enif_make_badarg(env); int32_t* ptr_x = (int32_t*)bin_x.data; /* validated with val_n */
    ErlNifBinary bin_y; if (!enif_inspect_binary(env, argv[1], &bin_y)) return enif_make_badarg(env); int32_t* ptr_y = (int32_t*)bin_y.data; /* validated with val_n */
...
static ERL_NIF_TERM nif_fp_map_axpy_i64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_x; if (!enif_inspect_binary(env, argv[0], &bin_x)) return enif_make_badarg(env); int64_t* ptr_x = (int64_t*)bin_x.data; /* validated with val_n */
    ErlNifBinary bin_y; if (!enif_inspect_binary(env, argv[1], &bin_y)) return enif_make_badarg(env); int64_t* ptr_y = (int64_t*)bin_y.data; /* validated with val_n */
...
static ERL_NIF_TERM nif_fp_map_axpy_i8(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_x; if (!enif_inspect_binary(env, argv[0], &bin_x)) return enif_make_badarg(env); int8_t* ptr_x = (int8_t*)bin_x.data; /* validated with val_n */
    ErlNifBinary bin_y; if (!enif_inspect_binary(env, argv[1], &bin_y)) return enif_make_badarg(env); int8_t* ptr_y = (int8_t*)bin_y.data; /* validated with val_n */
    ...
    if (!validate_binary_size(&bin_x, 1, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_y, 1, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_map_axpy_u16(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_x; if (!enif_inspect_binary(env, argv[0], &bin_x)) return enif_make_badarg(env); uint16_t* ptr_x = (uint16_t*)bin_x.data; /* validated with val_n */
    ErlNifBinary bin_y; if (!enif_inspect_binary(env, argv[1], &bin_y)) return enif_make_badarg(env); uint16_t* ptr_y = (uint16_t*)bin_y.data; /* validated with val_n */
...
static ERL_NIF_TERM nif_fp_map_axpy_u32(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_x; if (!enif_inspect_binary(env, argv[0], &bin_x)) return enif_make_badarg(env); uint32_t* ptr_x = (uint32_t*)bin_x.data; /* validated with val_n */
    ErlNifBinary bin_y; if (!enif_inspect_binary(env, argv[1], &bin_y)) return enif_make_badarg(env); uint32_t* ptr_y = (uint32_t*)bin_y.data; /* validated with val_n */
...
static ERL_NIF_TERM nif_fp_map_axpy_u64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_x; if (!enif_inspect_binary(env, argv[0], &bin_x)) return enif_make_badarg(env); uint64_t* ptr_x = (uint64_t*)bin_x.data; /* validated with val_n */
    ErlNifBinary bin_y; if (!enif_inspect_binary(env, argv[1], &bin_y)) return enif_make_badarg(env); uint64_t* ptr_y = (uint64_t*)bin_y.data; /* validated with val_n */
...
static ERL_NIF_TERM nif_fp_map_axpy_u8(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_x; if (!enif_inspect_binary(env, argv[0], &bin_x)) return enif_make_badarg(env); uint8_t* ptr_x = (uint8_t*)bin_x.data; /* validated with val_n */
    ErlNifBinary bin_y; if (!enif_inspect_binary(env, argv[1], &bin_y)) return enif_make_badarg(env); uint8_t* ptr_y = (uint8_t*)bin_y.data; /* validated with val_n */
...
static ERL_NIF_TERM nif_fp_multinomial_nb_train(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ...
    if (!validate_binary_size(&bin_X, 8, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_y, 4, (size_t)val_n)) return enif_make_badarg(env);
    MultinomialNBModel res = fp_multinomial_nb_train(ptr_X, ptr_y, val_n, val_d, val_n_classes, val_alpha); MultinomialNBModel* res_ptr = enif_alloc_resource(RES_TYPE_MultinomialNBModel, sizeof(MultinomialNBModel)); *res_ptr = res; ERL_NIF_TERM ret_res = enif_make_resource(env, res_ptr); enif_release_resource(res_ptr);
    return ret_res;
}
...
static ERL_NIF_TERM nif_fp_neural_network_create(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ...
    NeuralNetwork res = fp_neural_network_create(val_n_inputs, val_n_hidden, val_n_outputs, val_seed); NeuralNetwork* res_ptr = enif_alloc_resource(RES_TYPE_NeuralNetwork, sizeof(NeuralNetwork)); *res_ptr = res; ERL_NIF_TERM ret_res = enif_make_resource(env, res_ptr); enif_release_resource(res_ptr);
    return ret_res;
}
...
static ERL_NIF_TERM nif_fp_neural_network_train(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ...
    int val_n_hidden; if (!enif_get_int(env, argv[1], (int*)&val_n_hidden)) return enif_make_badarg(env);
    int val_n_outputs; if (!enif_get_int(env, argv[2], (int*)&val_n_outputs)) return enif_make_badarg(env);
    ErlNifBinary bin_X_train; if (!enif_inspect_binary(env, argv[3], &bin_X_train)) return enif_make_badarg(env); double* ptr_X_train = (double*)bin_X_train.data; /* validated with val_n_samples */
    ErlNifBinary bin_y_train; if (!enif_inspect_binary(env, argv[4], &bin_y_train)) return enif_make_badarg(env); double* ptr_y_train = (double*)bin_y_train.data; /* validated with val_n_samples */
    ...
    if (!validate_binary_size(&bin_X_train, 8, (size_t)val_n_samples)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_y_train, 8, (size_t)val_n_samples)) return enif_make_badarg(env);
    TrainingResult res = fp_neural_network_train(val_n_inputs, val_n_hidden, val_n_outputs, ptr_X_train, ptr_y_train, val_n_samples, val_n_epochs, val_learning_rate, val_verbose, val_seed); TrainingResult* res_ptr = enif_alloc_resource(RES_TYPE_TrainingResult, sizeof(TrainingResult)); *res_ptr = res; ERL_NIF_TERM ret_res = enif_make_resource(env, res_ptr); enif_release_resource(res_ptr);
    return ret_res;
}
...
static ERL_NIF_TERM nif_fp_pca_fit(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ...
    uint64_t val_seed; if (!enif_get_uint64(env, argv[6], (ErlNifUInt64*)&val_seed)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_X, 8, (size_t)val_n)) return enif_make_badarg(env);
    PCAResult res = fp_pca_fit(ptr_X, val_n, val_d, val_n_components, val_max_iterations, val_tolerance, val_seed); PCAResult* res_ptr = enif_alloc_resource(RES_TYPE_PCAResult, sizeof(PCAResult)); *res_ptr = res; ERL_NIF_TERM ret_res = enif_make_resource(env, res_ptr); enif_release_resource(res_ptr);
    return ret_res;
}
...
static ERL_NIF_TERM nif_fp_percentiles_f64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_data; if (!enif_inspect_binary(env, argv[0], &bin_data)) return enif_make_badarg(env); double* ptr_data = (double*)bin_data.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[1], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    ErlNifBinary bin_p_values; if (!enif_inspect_binary(env, argv[2], &bin_p_values)) return enif_make_badarg(env); double* ptr_p_values = (double*)bin_p_values.data; /* validated with val_n_percentiles */
    ...
    if (!validate_binary_size(&bin_data, 8, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_p_values, 8, (size_t)val_n_percentiles)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_pred_all_eq_const_i64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_arr; if (!enif_inspect_binary(env, argv[0], &bin_arr)) return enif_make_badarg(env); int64_t* ptr_arr = (int64_t*)bin_arr.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[1], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    int64_t val_value; if (!enif_get_int64(env, argv[2], (ErlNifSInt64*)&val_value)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_arr, 8, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_reduce_add_f64_where(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_x; if (!enif_inspect_binary(env, argv[0], &bin_x)) return enif_make_badarg(env); double* ptr_x = (double*)bin_x.data; /* validated with val_n */
    ErlNifBinary bin_mask; if (!enif_inspect_binary(env, argv[1], &bin_mask)) return enif_make_badarg(env); int* ptr_mask = (int*)bin_mask.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[2], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_x, 8, (size_t)val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_mask, 4, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_reduce_product_f64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_input; if (!enif_inspect_binary(env, argv[0], &bin_input)) return enif_make_badarg(env); double* ptr_input = (double*)bin_input.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[1], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    if (!validate_binary_size(&bin_input, 8, (size_t)val_n)) return enif_make_badarg(env);
...
static ERL_NIF_TERM nif_fp_rolling_max_i64(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ErlNifBinary bin_data; if (!enif_inspect_binary(env, argv[0], &bin_data)) return enif_make_badarg(env); int64_t* ptr_data = (int64_t*)bin_data.data; /* validated with val_n */
    size_t val_n; if (!enif_get_uint64(env, argv[1], (ErlNifUInt64*)&val_n)) return enif_make_badarg(env);
    size_t val_window; if (!enif_get_uint64(env, argv[2], (ErlNifUInt64*)&val_window)) return enif_make_badarg(env);
...
static ErlNifFunc generated_nif_funcs[] = { 
    {"fp_concat_i64", 5, nif_fp_concat_i64, 0},
    {"fp_contains_i64", 3, nif_fp_contains_i64, 0},
    {"fp_correlation_f64", 3, nif_fp_correlation_f64, 0},
    {"fp_count_i64", 3, nif_fp_count_i64, 0},
    {"fp_covariance_f64", 3, nif_fp_covariance_f64, 0},
    {"fp_detect_outliers_iqr_f64", 4, nif_fp_detect_outliers_iqr_f64, 0},
    {"fp_detect_outliers_zscore_f64", 4, nif_fp_detect_outliers_zscore_f64, 0},
    {"fp_drop_n_i64", 4, nif_fp_drop_n_i64, 0},
    {"fp_drop_while_gt_i64", 4, nif_fp_drop_while_gt_i64, 0},
    {"fp_ema_f64", 4, nif_fp_ema_f64, 0},
    {"fp_filter_gt_i64_simple", 4, nif_fp_filter_gt_i64_simple, 0},
    {"fp_find_index_i64", 3, nif_fp_find_index_i64, 0},
    {"fp_fold_dotp_f32", 3, nif_fp_fold_dotp_f32, 0},
    {"fp_fold_dotp_f64", 3, nif_fp_fold_dotp_f64, 0},
    {"fp_fold_dotp_i16", 3, nif_fp_fold_dotp_i16, 0},
    {"fp_fold_dotp_i32", 3, nif_fp_fold_dotp_i32, 0},
    {"fp_fold_dotp_i64", 3, nif_fp_fold_dotp_i64, 0},
    {"fp_fold_dotp_i8", 3, nif_fp_fold_dotp_i8, 0},
    {"fp_fold_dotp_u16", 3, nif_fp_fold_dotp_u16, 0},
    {"fp_fold_dotp_u32", 3, nif_fp_fold_dotp_u32, 0},
    {"fp_fold_dotp_u64", 3, nif_fp_fold_dotp_u64, 0},
    {"fp_fold_dotp_u8", 3, nif_fp_fold_dotp_u8, 0},
    {"fp_fold_sad_f32", 3, nif_fp_fold_sad_f32, 0},
    {"fp_fold_sad_i16", 3, nif_fp_fold_sad_i16, 0},
    {"fp_fold_sad_i32", 3, nif_fp_fold_sad_i32, 0},
    {"fp_fold_sad_i64", 3, nif_fp_fold_sad_i64, 0},
    {"fp_fold_sad_i8", 3, nif_fp_fold_sad_i8, 0},
    {"fp_fold_sad_u16", 3, nif_fp_fold_sad_u16, 0},
    {"fp_fold_sad_u32", 3, nif_fp_fold_sad_u32, 0},
    {"fp_fold_sad_u64", 3, nif_fp_fold_sad_u64, 0},
    {"fp_fold_sad_u8", 3, nif_fp_fold_sad_u8, 0},
    {"fp_fold_sumsq_f32", 2, nif_fp_fold_sumsq_f32, 0},
    {"fp_fold_sumsq_i16", 2, nif_fp_fold_sumsq_i16, 0},
    {"fp_fold_sumsq_i32", 2, nif_fp_fold_sumsq_i32, 0},
    {"fp_fold_sumsq_i64", 2, nif_fp_fold_sumsq_i64, 0},
    {"fp_fold_sumsq_i8", 2, nif_fp_fold_sumsq_i8, 0},
    {"fp_fold_sumsq_u16", 2, nif_fp_fold_sumsq_u16, 0},
    {"fp_fold_sumsq_u32", 2, nif_fp_fold_sumsq_u32, 0},
    {"fp_fold_sumsq_u64", 2, nif_fp_fold_sumsq_u64, 0},
    {"fp_fold_sumsq_u8", 2, nif_fp_fold_sumsq_u8, 0},
    {"fp_gaussian_nb_predict_batch", 4, nif_fp_gaussian_nb_predict_batch, 0},
    {"fp_gaussian_nb_train", 5, nif_fp_gaussian_nb_train, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"fp_group_i64", 4, nif_fp_group_i64, 0},
    {"fp_intersect_i64", 5, nif_fp_intersect_i64, 0},
    {"fp_iterate_add_i64", 4, nif_fp_iterate_add_i64, 0},
    {"fp_iterate_mul_i64", 4, nif_fp_iterate_mul_i64, 0},
    {"fp_kmeans_f64", 7, nif_fp_kmeans_f64, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"fp_linear_regression_r2_score", 3, nif_fp_linear_regression_r2_score, 0},
    {"fp_map_abs_f64", 3, nif_fp_map_abs_f64, 0},
    {"fp_map_abs_i64", 3, nif_fp_map_abs_i64, 0},
    {"fp_map_axpy_f32", 5, nif_fp_map_axpy_f32, 0},
    {"fp_map_axpy_f64", 5, nif_fp_map_axpy_f64, 0},
    {"fp_map_axpy_i16", 5, nif_fp_map_axpy_i16, 0},
    {"fp_map_axpy_i32", 5, nif_fp_map_axpy_i32, 0},
    {"fp_map_axpy_i64", 5, nif_fp_map_axpy_i64, 0},
    {"fp_map_axpy_i8", 5, nif_fp_map_axpy_i8, 0},
    {"fp_map_axpy_u16", 5, nif_fp_map_axpy_u16, 0},
    {"fp_map_axpy_u32", 5, nif_fp_map_axpy_u32, 0},
    {"fp_map_axpy_u64", 5, nif_fp_map_axpy_u64, 0},
    {"fp_map_axpy_u8", 5, nif_fp_map_axpy_u8, 0},
    {"fp_map_clamp_f64", 5, nif_fp_map_clamp_f64, 0},
    {"fp_map_clamp_i64", 5, nif_fp_map_clamp_i64, 0},
    {"fp_map_offset_f32", 4, nif_fp_map_offset_f32, 0},
    {"fp_map_offset_f64", 4, nif_fp_map_offset_f64, 0},
    {"fp_map_offset_i16", 4, nif_fp_map_offset_i16, 0},
    {"fp_map_offset_i32", 4, nif_fp_map_offset_i32, 0},
    {"fp_map_offset_i64", 4, nif_fp_map_offset_i64, 0},
    {"fp_map_offset_i8", 4, nif_fp_map_offset_i8, 0},
    {"fp_map_offset_u16", 4, nif_fp_map_offset_u16, 0},
    {"fp_map_offset_u32", 4, nif_fp_map_offset_u32, 0},
    {"fp_map_offset_u64", 4, nif_fp_map_offset_u64, 0},
    {"fp_map_offset_u8", 4, nif_fp_map_offset_u8, 0},
    {"fp_map_scale_f32", 4, nif_fp_map_scale_f32, 0},
    {"fp_map_scale_f64", 4, nif_fp_map_scale_f64, 0},
    {"fp_map_scale_i16", 4, nif_fp_map_scale_i16, 0},
    {"fp_map_scale_i32", 4, nif_fp_map_scale_i32, 0},
    {"fp_map_scale_i64", 4, nif_fp_map_scale_i64, 0},
    {"fp_map_scale_i8", 4, nif_fp_map_scale_i8, 0},
    {"fp_map_scale_u16", 4, nif_fp_map_scale_u16, 0},
    {"fp_map_scale_u32", 4, nif_fp_map_scale_u32, 0},
    {"fp_map_scale_u64", 4, nif_fp_map_scale_u64, 0},
    {"fp_map_scale_u8", 4, nif_fp_map_scale_u8, 0},
    {"fp_map_sqrt_f64", 3, nif_fp_map_sqrt_f64, 0},
    {"fp_moments_f64", 3, nif_fp_moments_f64, 0},
    {"fp_multinomial_nb_predict_batch", 4, nif_fp_multinomial_nb_predict_batch, 0},
    {"fp_multinomial_nb_train", 6, nif_fp_multinomial_nb_train, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"fp_neural_network_create", 4, nif_fp_neural_network_create, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"fp_neural_network_print_summary", 1, nif_fp_neural_network_print_summary, 0},
    {"fp_neural_network_train", 10, nif_fp_neural_network_train, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"fp_partition_gt_i64", 7, nif_fp_partition_gt_i64, 0},
    {"fp_pca_fit", 7, nif_fp_pca_fit, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"fp_pca_generate_ellipse_data", 6, nif_fp_pca_generate_ellipse_data, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"fp_pca_generate_low_rank_data", 6, nif_fp_pca_generate_low_rank_data, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"fp_percentile_f64", 3, nif_fp_percentile_f64, 0},
    {"fp_percentiles_f64", 5, nif_fp_percentiles_f64, 0},
    {"fp_pred_all_eq_const_i64", 3, nif_fp_pred_all_eq_const_i64, 0},
    {"fp_pred_all_gt_zip_i64", 3, nif_fp_pred_all_gt_zip_i64, 0},
    {"fp_pred_any_gt_const_i64", 3, nif_fp_pred_any_gt_const_i64, 0},
    {"fp_range_i64", 3, nif_fp_range_i64, 0},
    {"fp_reduce_add_f32", 2, nif_fp_reduce_add_f32, 0},
    {"fp_reduce_add_f64", 2, nif_fp_reduce_add_f64, 0},
    {"fp_reduce_add_f64_where", 3, nif_fp_reduce_add_f64_where, 0},
    {"fp_reduce_add_i16", 2, nif_fp_reduce_add_i16, 0},
    {"fp_reduce_add_i32", 2, nif_fp_reduce_add_i32, 0},
    {"fp_reduce_add_i64", 2, nif_fp_reduce_add_i64, 0},
    {"fp_reduce_add_i8", 2, nif_fp_reduce_add_i8, 0},
    {"fp_reduce_add_u16", 2, nif_fp_reduce_add_u16, 0},
    {"fp_reduce_add_u32", 2, nif_fp_reduce_add_u32, 0},
    {"fp_reduce_add_u64", 2, nif_fp_reduce_add_u64, 0},
    {"fp_reduce_add_u8", 2, nif_fp_reduce_add_u8, 0},
    {"fp_reduce_and_bool", 2, nif_fp_reduce_and_bool, 0},
    {"fp_reduce_max_f32", 2, nif_fp_reduce_max_f32, 0},
    {"fp_reduce_max_f64", 2, nif_fp_reduce_max_f64, 0},
    {"fp_reduce_max_i16", 2, nif_fp_reduce_max_i16, 0},
    {"fp_reduce_max_i32", 2, nif_fp_reduce_max_i32, 0},
    {"fp_reduce_max_i64", 2, nif_fp_reduce_max_i64, 0},
    {"fp_reduce_max_i8", 2, nif_fp_reduce_max_i8, 0},
    {"fp_reduce_max_u16", 2, nif_fp_reduce_max_u16, 0},
    {"fp_reduce_max_u32", 2, nif_fp_reduce_max_u32, 0},
    {"fp_reduce_max_u64", 2, nif_fp_reduce_max_u64, 0},
    {"fp_reduce_max_u8", 2, nif_fp_reduce_max_u8, 0},
    {"fp_reduce_min_f32", 2, nif_fp_reduce_min_f32, 0},
    {"fp_reduce_min_f64", 2, nif_fp_reduce_min_f64, 0},
    {"fp_reduce_min_i16", 2, nif_fp_reduce_min_i16, 0},
    {"fp_reduce_min_i32", 2, nif_fp_reduce_min_i32, 0},
    {"fp_reduce_min_i64", 2, nif_fp_reduce_min_i64, 0},
    {"fp_reduce_min_i8", 2, nif_fp_reduce_min_i8, 0},
    {"fp_reduce_min_u16", 2, nif_fp_reduce_min_u16, 0},
    {"fp_reduce_min_u32", 2, nif_fp_reduce_min_u32, 0},
    {"fp_reduce_min_u64", 2, nif_fp_reduce_min_u64, 0},
    {"fp_reduce_min_u8", 2, nif_fp_reduce_min_u8, 0},
    {"fp_reduce_mul_f32", 2, nif_fp_reduce_mul_f32, 0},
    {"fp_reduce_mul_i16", 2, nif_fp_reduce_mul_i16, 0},
    {"fp_reduce_mul_i32", 2, nif_fp_reduce_mul_i32, 0},
    {"fp_reduce_mul_i8", 2, nif_fp_reduce_mul_i8, 0},
    {"fp_reduce_mul_u16", 2, nif_fp_reduce_mul_u16, 0},
    {"fp_reduce_mul_u32", 2, nif_fp_reduce_mul_u32, 0},
    {"fp_reduce_mul_u64", 2, nif_fp_reduce_mul_u64, 0},
    {"fp_reduce_mul_u8", 2, nif_fp_reduce_mul_u8, 0},
    {"fp_reduce_or_bool", 2, nif_fp_reduce_or_bool, 0},
    {"fp_reduce_product_f64", 2, nif_fp_reduce_product_f64, 0},
    {"fp_reduce_product_i64", 2, nif_fp_reduce_product_i64, 0},
    {"fp_replicate_f64", 3, nif_fp_replicate_f64, 0},
    {"fp_replicate_i64", 3, nif_fp_replicate_i64, 0},
    {"fp_reverse_i64", 3, nif_fp_reverse_i64, 0},
    {"fp_rolling_max_f64", 4, nif_fp_rolling_max_f64, 0},
    {"fp_rolling_max_i64", 4, nif_fp_rolling_max_i64, 0},
    {"fp_rolling_mean_f64", 4, nif_fp_rolling_mean_f64, 0},
    {"fp_rolling_mean_f64_optimized", 4, nif_fp_rolling_mean_f64_optimized, 0},
    {"fp_rolling_min_f64", 4, nif_fp_rolling_min_f64, 0},
    {"fp_rolling_min_i64", 4, nif_fp_rolling_min_i64, 0},
    {"fp_rolling_range_f64", 4, nif_fp_rolling_range_f64, 0},
    {"fp_rolling_std_f64", 4, nif_fp_rolling_std_f64, 0},
    {"fp_rolling_sum_f64", 4, nif_fp_rolling_sum_f64, 0},
    {"fp_rolling_sum_f64_optimized", 4, nif_fp_rolling_sum_f64_optimized, 0},
    {"fp_rolling_sum_i64", 4, nif_fp_rolling_sum_i64, 0},
    {"fp_rolling_variance_f64", 4, nif_fp_rolling_variance_f64, 0},
    {"fp_run_length_encode_i64", 3, nif_fp_run_length_encode_i64, 0},
    {"fp_scan_add_f64", 3, nif_fp_scan_add_f64, 0},
    {"fp_scan_add_i64", 3, nif_fp_scan_add_i64, 0},
    {"fp_slice_i64", 5, nif_fp_slice_i64, 0},
    {"fp_sma_f64", 4, nif_fp_sma_f64, 0},
    {"fp_take_n_i64", 4, nif_fp_take_n_i64, 0},
    {"fp_take_while_gt_i64", 4, nif_fp_take_while_gt_i64, 0},
    {"fp_training_result_free", 1, nif_fp_training_result_free, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"fp_training_result_print", 1, nif_fp_training_result_print, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"fp_union_i64", 5, nif_fp_union_i64, 0},
    {"fp_unique_i64", 3, nif_fp_unique_i64, 0},
    {"fp_wma_f64", 4, nif_fp_wma_f64, 0},
    {"fp_zip_add_f32", 4, nif_fp_zip_add_f32, 0},
    {"fp_zip_add_f64", 4, nif_fp_zip_add_f64, 0},
    {"fp_zip_add_i16", 4, nif_fp_zip_add_i16, 0},
    {"fp_zip_add_i32", 4, nif_fp_zip_add_i32, 0},
    {"fp_zip_add_i64", 4, nif_fp_zip_add_i64, 0},
    {"fp_zip_add_i8", 4, nif_fp_zip_add_i8, 0},
    {"fp_zip_add_u16", 4, nif_fp_zip_add_u16, 0},
    {"fp_zip_add_u32", 4, nif_fp_zip_add_u32, 0},
    {"fp_zip_add_u64", 4, nif_fp_zip_add_u64, 0},
    {"fp_zip_add_u8", 4, nif_fp_zip_add_u8, 0},
    {"fp_zip_with_index_i64", 3, nif_fp_zip_with_index_i64, 0},
    {"get_KMeansResult_centroids", 2, nif_get_KMeansResult_centroids, 0},
    {"get_KMeansResult_assignments", 2, nif_get_KMeansResult_assignments, 0},
    {"get_KMeansResult_inertia", 2, nif_get_KMeansResult_inertia, 0},
    {"get_KMeansResult_converged", 2, nif_get_KMeansResult_converged, 0},
